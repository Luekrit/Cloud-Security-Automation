...
```mermaid
flowchart TB
    API["Risk action<br/>IAM AttachUserPolicy<br/>AdministratorAccess → iam-test-*"]
...
![Test A SNS Alert](diagrams/Screenshot 2026-06-01 004841.png)
...
![Test B SNS Alert](diagrams/Screenshot 2026-05-29 114800.png)
